import aiohttp, asyncio, argparse, asyncpg, pathlib, asyncmy, ssl, oci
...
transaction = oci.database.models.CreateAutonomousDatabaseBase(compartment_id=configure.get('tenancy'), db_name='transaction', admin_password='ora1cle+ORAC', cpu_core_count=1, data_storage_size_in_tbs=1, db_workload='OLTP', is_free_tier=True)
...
print(_.id for _ in databaseClient.list_autonomous_databases(compartment_id=configure.get('tenancy')).data)
