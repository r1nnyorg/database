...
transaction = oci.database.models.CreateAutonomousDatabaseBase(compartment_id=configure.get('tenancy'), db_name='transaction', admin_password='ora1cle+ORAC', db_workload='OLTP', is_free_tier=True)
